...
if ( ! class_exists( 'Soliloquy_Metaboxes' ) ) :
	...
	class Soliloquy_Metaboxes {
		...
		public function metabox_scripts( $hook ) {
			...
			// allow only on soliloquy post type.
...
endforeach;
		...
		public function code_panel( $post ) {
			...
			<iframe width="560" height="315" src="https://www.youtube.com/embed/045Axc4GXoA?si=U1aZOtjuhZGjKcmH" frameborder="0" allowfullscreen></iframe>
			</div>
			<?php
		}
				...
				<table class="form-table">
					...
					<tbody>
						...
						<tr id="soliloquy-config-classes-box">
							...
							<td>
								<textarea id="soliloquy-config-classes" rows="5" cols="75" name="_soliloquy[classes]" placeholder="<?php esc_html_e( 'Enter custom slider CSS classes here, one per line.', 'soliloquy' ); ?>"><?php echo esc_html( implode( "\n", (array) $this->get_config( 'classes', $this->get_config_default( 'classes' ) ) ) ); ?></textarea>
