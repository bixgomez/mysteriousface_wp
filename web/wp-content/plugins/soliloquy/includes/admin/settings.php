					...
					<tr id="soliloquy-serialization-box">
						...
						<td>
							...
							<form id="soliloquy-serialization" method="post">
								...
								<p class="description"><?php printf( esc_html__( 'If you have changed the URL of your WordPress web site, and manually executed a search/replace query on URLs in your WordPress database, your sliders will probably no longer show any slides.  %s, click the button above to fix this. We recommend using a migration plugin or script next time :)', 'soliloquy' ), '<strong>' . __( 'If this is the case' ) . '</strong>' ); ?></p>
