													...
													<div class="thumbnail">
														<div class="inside">
															...
															if ( ! empty( $slider['config']['title'] ) ) {
																...
																$title = sprintf( esc_html__( 'Slider ID #%s', 'soliloquy' ), $slider['id'] );
															}
															?>
